...
#    0x1b       => transition_to(:ESCAPE), AD: removed for ESC ESC = ESC
...
$states[:GROUND] = {
    0x00..0x17 => :execute,
    0x1b       => transition_to(:ESCAPE), # AD: moved for ESC ESC = ESC
    0x19       => :execute,
    0x1c..0x1f => :execute,
    0x20..0x7f => :print,
}
...
$states[:ESCAPE] = {
    ...
    0x30..0x4e => [:esc_dispatch, transition_to(:GROUND)],
    0x4f       => [:collect, transition_to(:ESCAPE_INTERMEDIATE)],  # AD ESC OP
